...
it("holds Rail geometry, states, and optical alignment", { timeout: 240_000 }, async () => {
    ...
    expect(document.querySelectorAll('[data-happy-desktop-ui="rail-brand-glyph"]')).toHaveLength(0);

    /* Supplied brand content replaces the star inside the same centered slot. */
    expect(
        document.querySelectorAll(
            '[data-testid="rail-custom"] [data-happy-desktop-ui="rail-brand-image"]',
        ),
    ).toHaveLength(0);
    ...
    const appearanceToggle = view.$(
        '[data-testid="rail-appearance"] [data-happy-desktop-ui="rail-appearance-toggle"]',
    );
    ...
    expect(
        view
            .$(
                '[data-testid="rail-appearance"] [data-happy-desktop-ui="rail-appearance-toggle"] [data-happy-desktop-ui="icon"]',
            )
    ...
    expect(
        view
            .$(
                '[data-testid="rail-main"] [data-item-id="agents"] [data-happy-desktop-ui="rail-item-label"]',
            )
            .computedStyle("color"),
    ).toBe("rgb(0, 0, 0)");
    ...
    const chatIconBox = view.$(
        '[data-testid="rail-main"] [data-item-id="chat"] [data-happy-desktop-ui="rail-item-icon"]',
    );
    ...
    const chatIcon = view.$(
        '[data-testid="rail-main"] [data-item-id="chat"] [data-happy-desktop-ui="icon"]',
    );
    ...
    for (const [railId, itemId] of [
        ...
        const icon = view.$(
            `[data-testid="${railId}"] [data-item-id="${itemId}"] [data-happy-desktop-ui="icon"]`,
        );
        expect((await icon.visibleMetrics()).pixelCount, `${itemId} icon ink`).toBeGreaterThan(0);
    }

    const chatLabel = view.$(
        '[data-testid="rail-main"] [data-item-id="chat"] [data-happy-desktop-ui="rail-item-label"]',
    );
    ...
    for (const [railId, itemId, text] of [
        ...
        const label = view.$(
            `[data-testid="${railId}"] [data-item-id="${itemId}"] [data-happy-desktop-ui="rail-item-label"]`,
        );
    ...
    const longLabel = view.$(
        '[data-testid="rail-badges"] [data-item-id="long-label"] [data-happy-desktop-ui="rail-item-label"]',
    );
    ...
    for (const [itemId, text] of [
        ...
        const badge = view.$(
            `[data-testid="rail-badges"] [data-item-id="${itemId}"] [data-happy-desktop-ui="rail-item-badge"]`,
        );
        const iconBox = view.$(
            `[data-testid="rail-badges"] [data-item-id="${itemId}"] [data-happy-desktop-ui="rail-item-icon"]`,
        );
        expect(
        ...
        const count = view.$(
            `[data-testid="rail-badges"] [data-item-id="${itemId}"] [data-happy-desktop-ui="count-badge"]`,
        );
    ...
    const count12 = view.$(
        '[data-testid="rail-main"] [data-item-id="inbox"] [data-happy-desktop-ui="count-badge"]',
    );
    ...
    expect(
        document.querySelectorAll(
            '[data-testid="rail-main"] [data-item-id="chat"] [data-happy-desktop-ui="rail-item-badge"]',
        ).length,
    ).toBe(0);

    /* ---- Footer pinned to the bottom ---------------------------------------- */

    const footer = view.$('[data-testid="rail-main"] [data-happy-desktop-ui="rail-footer"]');
    const footerBounds = footer.bounds();
    expect(footerBounds.y + footerBounds.height).toBe(420 - 16);
    const footerAction = view.$(
        '[data-testid="rail-main"] [data-happy-desktop-ui="rail-footer-action"]',
    );
    ...
    const footerAvatar = view.$('[data-testid="rail-main"] [data-happy-desktop-ui="avatar"]');
    ...
    const primary = view.$('[data-testid="rail-main"] [data-happy-desktop-ui="rail-primary"]');
    ...
    expect(
        document.querySelectorAll(
            '[data-testid="rail-custom"] [data-happy-desktop-ui="rail-footer"]',
        ).length,
    ).toBe(0);
    ...
    const createAgent = view.$(
        '[data-testid="rail-main"] [data-happy-desktop-ui="rail-primary-popover"] [data-item-id="agent"]',
    );
