...
it("lists this machine's notes, opens one, and deletes only through the confirmation", async () => {
    ...
    const rows = document.querySelectorAll('[data-happy-desktop-ui="notes-page-row"]');
    ...
    const deletes = document.querySelectorAll('[data-happy-desktop-ui="notes-page-row-delete"]');
