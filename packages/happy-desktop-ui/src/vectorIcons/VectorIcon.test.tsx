...
it("holds vector-icon box geometry, font, and PUA glyph across sizes", async () => {
    ...
    for (const size of SIZES) {
        const icon = view.$(
            `[data-testid="ion-size-${size}"] [data-happy-desktop-ui="vector-icon"]`,
        );
    ...
    const ionDefault = view.$('[data-testid="ion-default"] [data-happy-desktop-ui="vector-icon"]');
    ...
    const colored = view.$('[data-testid="ion-colored"] [data-happy-desktop-ui="vector-icon"]');
