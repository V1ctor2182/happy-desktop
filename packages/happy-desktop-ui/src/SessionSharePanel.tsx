...
function MemberRow(props: {
    ...
    return (
        <li
            ...
            data-happy-desktop-ui="session-share-member"
        ...
        >
            ...
            <span
                ...
                data-happy-desktop-ui="session-share-member-identity"
            >
                <span
                    className="happy2-session-share-panel__member-name"
                    data-happy-desktop-ui="session-share-member-name"
                >
                    {member.name}
                </span>
                <span
                    className="happy2-session-share-panel__member-access"
                    data-happy-desktop-ui="session-share-member-access"
                >
...
export function SessionSharePanel(props: SessionSharePanelProps) {
    ...
    return (
        <section
            ...
            data-happy-desktop-ui="session-share-panel"
        ...
        >
            ...
            <div
                ...
                data-happy-desktop-ui="session-share-panel-body"
            >
                {local.error ? (
                ...
                {health ? (
                    <div
                        ...
                        data-happy-desktop-ui="session-share-health"
                    >
                        <span
                            className="happy2-session-share-panel__health-line"
                            data-happy-desktop-ui="session-share-health-line"
                        >
                            <span
                                aria-hidden="true"
                        ...
                        {health.checkedTime ? (
                            <span
                                ...
                                data-happy-desktop-ui="session-share-health-checked"
                            >
                ...
                {local.friendMessagesInContext !== undefined ? (
                    ended ? (
                        <p
                            ...
                            data-happy-desktop-ui="session-share-friend-messages"
                        >
                ...
                {local.loading && local.members.length === 0 ? (
                    ...
                    <ul
                        ...
                        data-happy-desktop-ui="session-share-members"
                    >
                ...
                {ended ? (
                    <div
                        ...
                        data-happy-desktop-ui="session-share-record"
                    >
                    ...
                    <div
                        ...
                        data-happy-desktop-ui="session-share-stop"
                    >
                        <Button
