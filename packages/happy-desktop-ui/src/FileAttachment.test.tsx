...
it("holds FileAttachment geometry, typography, truncation, and interactivity", async () => {
    ...
    const fa = view.$('[data-testid="fa"] [data-happy-desktop-ui="file-attachment"]');
    ...
    /* ---- Doc glyph, name, size ----------------------------------------- */
    const icon = view.$(
        '[data-testid="fa"] [data-happy-desktop-ui="file-attachment-icon"] [data-happy-desktop-ui="icon"]',
    );
    expect(icon.element.getAttribute("data-name")).toBe("doc");
    const name = view.$('[data-testid="fa"] [data-happy-desktop-ui="file-attachment-name"]');
    ...
    const ro = view.$('[data-testid="ro"] [data-happy-desktop-ui="file-attachment"]');
    expect(ro.element.tagName, "no onOpen → static div").toBe("DIV");
    /* ---- Long names truncate with an ellipsis; the size never shrinks --- */
    const tName = view.$('[data-testid="trunc"] [data-happy-desktop-ui="file-attachment-name"]');
    ...
    const tSize = view.$('[data-testid="trunc"] [data-happy-desktop-ui="file-attachment-size"]');
    ...
    const chat = view.$('[data-testid="chat"] [data-happy-desktop-ui="file-attachment"]');
    ...
    const chatIcon = view.$('[data-testid="chat"] [data-happy-desktop-ui="file-attachment-icon"]');
    ...
    const chatName = view.$('[data-testid="chat"] [data-happy-desktop-ui="file-attachment-name"]');
    expect(chatName.computedStyles(["font-size", "font-weight", "line-height"])).toEqual({
        "font-size": "14px",
        "font-weight": "600",
        "line-height": "20px",
    });
    const chatMeta = view.$('[data-testid="chat"] [data-happy-desktop-ui="file-attachment-meta"]');
    expect(chatMeta.element.textContent).toContain("HTML · 283 KB");
    const narrowChat = view.$(
        '[data-testid="chat-narrow"] [data-happy-desktop-ui="file-attachment"]',
    );
    expect(narrowChat.bounds().width, "card respects a constrained message").toBe(284);
    expect(
        view.$('[data-testid="chat-narrow"] [data-happy-desktop-ui="file-attachment-name"]').element
            .scrollWidth,
    ...
    const action = view.$('[data-testid="chat"] [data-happy-desktop-ui="file-attachment-action"]');
