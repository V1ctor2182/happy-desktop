 ...
 */
export interface RigSidebarCollapseDocument {
 ...
 */
export interface RigSidebarCollapsePersistence {
    read(): RigSidebarCollapseDocument | undefined;
    write(document: RigSidebarCollapseDocument): void;
}

export interface RigSidebarCollapseSnapshot {
    /** Every row this window has been told to fold shut, still folded. */
    readonly collapsed: ReadonlySet<string>;
}

export interface RigSidebarCollapseStore {
    get(): RigSidebarCollapseSnapshot;
...
function documentParse(value: unknown): RigSidebarCollapseDocument | undefined {
...
const EMPTY_SNAPSHOT: RigSidebarCollapseSnapshot = { collapsed: new Set<string>() };
 ...
 */
export function rigSidebarCollapseStoreCreate(
    persistence?: RigSidebarCollapsePersistence,
): RigSidebarCollapseStore {
    let snapshot: RigSidebarCollapseSnapshot = (() => {
        try {
 ...
 */
export const rigSidebarCollapseStoreNoop: RigSidebarCollapseStore = {
    get: () => EMPTY_SNAPSHOT,
    subscribe: () => () => undefined,
