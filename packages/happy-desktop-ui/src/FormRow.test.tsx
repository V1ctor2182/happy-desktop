...
it("holds FormRow layout, typography, colors, divider, and control alignment", async () => {
    ...
    const inlineText = view.$('[data-testid="inline"] [data-happy-desktop-ui="form-row-text"]');
    ...
    const inlineControl = view.$(
        '[data-testid="inline"] [data-happy-desktop-ui="form-row-control"]',
    );
    ...
    const description = view.$(
        '[data-testid="inline"] [data-happy-desktop-ui="form-row-description"]',
    );
    ...
    await assertLegibleUnclipped(
        view,
        '[data-testid="inline"] [data-happy-desktop-ui="form-row-label"]',
    );
    await assertLegibleUnclipped(
        view,
        '[data-testid="inline"] [data-happy-desktop-ui="form-row-description"]',
    ...
    const plainText = view.$('[data-testid="plain"] [data-happy-desktop-ui="form-row-text"]');
    expect(plainText.height(), "label-only text height").toBe(20);
    // No description prop → no description element is rendered.
    expect(
        view.container.querySelector(
            '[data-testid="plain"] [data-happy-desktop-ui="form-row-description"]',
        ),
        "label-only row omits description",
    ).toBeNull();
    const plainControl = view.$('[data-testid="plain"] [data-happy-desktop-ui="form-row-control"]');
    ...
    const plainButton = '[data-testid="plain"] [data-happy-desktop-ui="button"]';
    ...
    expect(
        (await view.$(`${plainButton} [data-happy-desktop-ui="icon"]`).visibleMetrics()).pixelCount,
        "plus glyph ink",
    ).toBeGreaterThan(0);
    // ---- Stacked row --------------------------------------------------------
    ...
    const stackedText = view.$('[data-testid="stacked"] [data-happy-desktop-ui="form-row-text"]');
    const stackedControl = view.$(
        '[data-testid="stacked"] [data-happy-desktop-ui="form-row-control"]',
    );
    ...
    const centerControl = view.$(
        '[data-testid="align-center"] [data-happy-desktop-ui="form-row-control"]',
    );
    const startControl = view.$(
        '[data-testid="align-start"] [data-happy-desktop-ui="form-row-control"]',
    );
    ...
    expect(
        (
            await view
                .$('[data-testid="align-center"] [data-happy-desktop-ui="badge"]')
                .visibleMetrics()
        ).pixelCount,
        "center badge ink",
    ).toBeGreaterThan(0);
    expect(
        (
            await view
                .$('[data-testid="align-start"] [data-happy-desktop-ui="badge"]')
                .visibleMetrics()
        ).pixelCount,
        "start badge ink",
    ).toBeGreaterThan(0);
