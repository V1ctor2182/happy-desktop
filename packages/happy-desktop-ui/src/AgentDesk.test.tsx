...
it("holds AgentDesk geometry, colors, and typography in the 340px shell panel", async () => {
    ...
    const header = view.$('[data-happy-desktop-ui="agent-desk-header"]');
    ...
    const title = view.$('[data-happy-desktop-ui="agent-desk-title"]');
    ...
    const titleInk = await ink(view, '[data-happy-desktop-ui="agent-desk-title"]', 23.5);
    ...
    const detail = view.$('[data-happy-desktop-ui="agent-desk-run-detail"]');
    expect(
    ...
    const queuedRows = desk.element.querySelectorAll('[data-happy-desktop-ui="agent-desk-queued"]');
    expect(queuedRows.length).toBe(2);
    const queuedOne = view.$('[data-happy-desktop-ui="agent-desk-queued"]');
    ...
    const queuedTitle = view.$(
        '[data-happy-desktop-ui="agent-desk-queued"] [data-happy-desktop-ui="agent-desk-row-title"]',
    );
    ...
    const queuedMeta = view.$(
        '[data-happy-desktop-ui="agent-desk-queued"] [data-happy-desktop-ui="agent-desk-row-meta"]',
    );
    ...
    const doneOne = view.$('[data-happy-desktop-ui="agent-desk-done"]');
    ...
    const doneTitle = view.$(
        '[data-happy-desktop-ui="agent-desk-done"] [data-happy-desktop-ui="agent-desk-row-title"]',
    );
    ...
    const doneMetaInk = await ink(
        view,
        '[data-happy-desktop-ui="agent-desk-done"] [data-happy-desktop-ui="agent-desk-row-meta"]',
        16,
    );
    ...
    const runTitlePart = view.$('[data-happy-desktop-ui="agent-desk-run-title"]');
    const rowTitlePart = view.$('[data-happy-desktop-ui="agent-desk-row-title"]');
    if (engine() === "chromium") {
...
async function expectDeskCentered(view: View, testId: string) {
    ...
    const runEta = await ink(view, `${p} [data-happy-desktop-ui="agent-desk-run-eta"]`, 10);
    ...
    const queuedTitle = await ink(
        view,
        `${p} [data-happy-desktop-ui="agent-desk-queued"] [data-happy-desktop-ui="agent-desk-row-title"]`,
        18,
    );
    ...
    const queuedMeta = await ink(
        view,
        `${p} [data-happy-desktop-ui="agent-desk-queued"] [data-happy-desktop-ui="agent-desk-row-meta"]`,
        18,
    );
    ...
    const doneTitle = await ink(
        view,
        `${p} [data-happy-desktop-ui="agent-desk-done"] [data-happy-desktop-ui="agent-desk-row-title"]`,
        16,
    );
    expect(Math.abs(doneTitle.dy), `${testId} done title dy`).toBeLessThanOrEqual(TEXT_TOLERANCE);
    const doneMeta = await ink(
        view,
        `${p} [data-happy-desktop-ui="agent-desk-done"] [data-happy-desktop-ui="agent-desk-row-meta"]`,
        16,
    );
...
it("keeps ink optically centered at 280 and 400 widths and in a scrolling desk", async () => {
    ...
    const runEta = await ink(view, `${s} [data-happy-desktop-ui="agent-desk-run-eta"]`, 10);
    ...
    const doneMeta = await ink(
        view,
        `${s} [data-happy-desktop-ui="agent-desk-done"] [data-happy-desktop-ui="agent-desk-row-meta"]`,
        16,
    );
...
it("handles custom icons, 1-char initials, and truncating labels", async () => {
    ...
    const avatar = view.$(
        '[data-happy-desktop-ui="agent-desk-run"] [data-happy-desktop-ui="avatar"]',
    );
...
it("stays fluid, clamps progress, and scrolls overflowing content", async () => {
    ...
    expect(
        narrow.element.querySelector('[data-happy-desktop-ui="agent-desk-run-track"]'),
    ).toBeNull();
    expect(narrow.element.querySelector('[data-happy-desktop-ui="agent-desk-run-eta"]')).toBeNull();
    expect(
        narrow.element.querySelectorAll('[data-happy-desktop-ui="agent-desk-section-label"]')
            .length,
    ).toBe(0);
    ...
    const wideTracks = view
        .$('[data-testid="desk-wide"]')
        .element.querySelectorAll('[data-happy-desktop-ui="agent-desk-run-track"]');
