            ...
            >
                {frame(
                    <ChangedFileDiff
                        ...
                        path="packages/happy2-ui/src/elapsed.ts"
                        preview={preview("packages/happy2-ui/src/elapsed.ts", source)}
                    />,
                    300,
                )}
            </Specimen>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    ...
                    {frame(
                        <ChangedFileDiff
                            ...
                            newContent={source}
                            oldContent={sourceBefore}
                            oldPath="packages/happy2-ui/src/duration.ts"
                            path="packages/happy2-ui/src/elapsed.ts"
                            preview={preview("packages/happy2-ui/src/elapsed.ts", source)}
                        />,
                        260,
                    ...
                    {frame(
                        <ChangedFileDiff
                            ...
                            oldContent={source}
                            path="packages/happy2-ui/src/elapsed.ts"
                            preview={preview("packages/happy2-ui/src/elapsed.ts", "")}
                        />,
                        220,
                    )}
                </div>
