            ...
            <span className="happy2-shared-sessions__body">
                <span className="happy2-shared-sessions__heading">
                    <span
                        ...
                        data-happy2-ui="shared-sessions-title"
                    >
                        {session.title}
                    </span>
                    <Badge
                ...
                <span
                    ...
                    data-happy2-ui="shared-sessions-note"
                >
                    {rowNote(session)}
                </span>
            </span>
...
export function SharedSessionsPage(props: SharedSessionsPageProps) {
    ...
    return (
        <div
            ...
            data-happy2-ui="shared-sessions"
            data-testid={props["data-testid"]}
            style={props.style}
        >
            <div className="happy2-shared-sessions__header" data-happy2-ui="shared-sessions-header">
                <Toolbar
            ...
            <div className="happy2-shared-sessions__scroll" data-happy2-ui="shared-sessions-scroll">
                <div
                    className="happy2-shared-sessions__content"
                    data-happy2-ui="shared-sessions-content"
                >
                    {props.error ? (
                    ...
                    {sessions.length > 0 ? (
                        <div
                            ...
                            data-happy2-ui="shared-sessions-list"
                        >
                            {sessions.map((session) => {
                                ...
                                return props.onSessionOpen ? (
                                    <button
                                        ...
                                        data-happy2-ui="shared-sessions-row"
