...
export default defineConfig(
    // The route tree is generated by @tanstack/router-plugin; its own header
    // asks that linters and formatters leave it alone.
    globalIgnores(["dist/**", "coverage/**", "sources/routeTree.gen.ts"]),
