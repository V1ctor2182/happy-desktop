...
import type { NoteStore, NoteSummary, NotesStore } from "happy2-state";
...
export function NotesPage(props: NotesPageProps) {
    ...
    const list = () => {
        ...
        return (
            <div className="happy2-notes-page__list" data-happy2-ui="notes-page-list">
                {notes.map((note) => (
                    <div
                    ...
                    >
                        ...
                        {props.onDelete ? (
                            <button
                                ...
                                data-happy2-ui="notes-page-row-delete"
