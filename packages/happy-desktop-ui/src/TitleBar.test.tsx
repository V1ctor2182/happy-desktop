...
it("holds TitleBar geometry: 56px contract, grid lanes, drag chrome", async () => {
    ...
    const bar = view
        .$('[data-testid="crumb"]')
        .element.closest("[data-happy-desktop-ui='title-bar']")!;
    const root = view.$('[data-happy-desktop-ui="title-bar"]:not([data-window-controls])');
    ...
    const trailing = view.$(
        '[data-happy-desktop-ui="title-bar"]:not([data-window-controls]) [data-happy-desktop-ui="title-bar-trailing"]',
    );
    ...
    const field = view.$(
        '[data-happy-desktop-ui="title-bar"]:not([data-window-controls]) [data-happy-desktop-ui="search-field"]',
    );
    expect(field.bounds()).toEqual({ x: 470, y: 12, width: 420, height: 32 });
    const input = view.$(
        '[data-happy-desktop-ui="title-bar"]:not([data-window-controls]) [data-happy-desktop-ui="search-field-input"]',
    );
    ...
    const insetRoot = view.$('[data-happy-desktop-ui="title-bar"][data-window-controls]');
    ...
    const insetLeading = view.$(
        '[data-happy-desktop-ui="title-bar"][data-window-controls] [data-happy-desktop-ui="title-bar-leading"]',
    );
    const insetCenter = view.$(
        '[data-happy-desktop-ui="title-bar"][data-window-controls] [data-happy-desktop-ui="title-bar-center"]',
    );
    const insetTrailing = view.$(
        '[data-happy-desktop-ui="title-bar"][data-window-controls] [data-happy-desktop-ui="title-bar-trailing"]',
    );
    ...
    const controls = view.$('[data-happy-desktop-ui="title-bar-controls"]');
    ...
    const insetField = view.$(
        '[data-happy-desktop-ui="title-bar"][data-window-controls] [data-happy-desktop-ui="search-field"]',
    );
...
it("holds SearchField geometry, colors, and optical centering", async () => {
    ...
    const field = view.$('[data-testid="fixed"] [data-happy-desktop-ui="search-field"]');
    ...
    const icon = view.$('[data-testid="fixed"] [data-happy-desktop-ui="search-field-icon"]');
    const iconGlyph = view.$(
        '[data-testid="fixed"] [data-happy-desktop-ui="search-field-icon"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const input = view.$('[data-testid="fixed"] [data-happy-desktop-ui="search-field-input"]');
    ...
    const cap = view.$('[data-testid="fixed"] [data-happy-desktop-ui="key-cap"]');
    ...
    const capLabel = view.$('[data-testid="fixed"] [data-happy-desktop-ui="key-cap-label"]');
    const capControl = view.$(
        '[data-testid="cap-control-k"] [data-happy-desktop-ui="key-cap-label"]',
    );
    ...
    const fluid = view.$('[data-testid="fluid"] [data-happy-desktop-ui="search-field"]');
    expect(fluid.bounds()).toEqual({ x: 12, y: 12, width: 236, height: 32 });
    const fluidCapLabel = view.$('[data-testid="fluid"] [data-happy-desktop-ui="key-cap-label"]');
    expect(
        view
            .$('[data-testid="fluid"] [data-happy-desktop-ui="key-cap"]')
    ...
    const fluidCapControl = view.$(
        '[data-testid="cap-control-p"] [data-happy-desktop-ui="key-cap-label"]',
    );
    ...
    const placeholderInput = view.$(
        '[data-testid="fluid"] [data-happy-desktop-ui="search-field-input"]',
    );
    ...
    const pairPh = view.$('[data-testid="pair-ph"] [data-happy-desktop-ui="search-field-input"]');
    const pairVal = view.$('[data-testid="pair-val"] [data-happy-desktop-ui="search-field-input"]');
...
it("holds SearchField focus treatment and long-content truncation", async () => {
    ...
    const field = view.$('[data-testid="focus"] [data-happy-desktop-ui="search-field"]');
    const input = view.$('[data-testid="focus"] [data-happy-desktop-ui="search-field-input"]');
    ...
    const longField = view.$('[data-testid="long-value"] [data-happy-desktop-ui="search-field"]');
    const longInput = view.$(
        '[data-testid="long-value"] [data-happy-desktop-ui="search-field-input"]',
    );
    const longCap = view.$('[data-testid="long-value"] [data-happy-desktop-ui="key-cap"]');
    ...
    const phField = view.$('[data-testid="long-ph"] [data-happy-desktop-ui="search-field"]');
    const phInput = view.$('[data-testid="long-ph"] [data-happy-desktop-ui="search-field-input"]');
    ...
    expect(
        ...
        view.$('[data-testid="long-ph"] [data-happy-desktop-ui="key-cap"]').bounds().x,
    );
...
it("reports SearchField input and submit through callbacks", async () => {
    ...
    const input = view.$('[data-happy-desktop-ui="search-field-input"]')
