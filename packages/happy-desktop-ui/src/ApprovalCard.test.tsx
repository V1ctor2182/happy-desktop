...
it("holds pending ApprovalCard geometry, typography, and interactions", async () => {
    ...
    const chip = view.$('[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-chip"]');
    ...
    const shield = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-chip"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const badge = view.$('[data-testid="ac-pending"] [data-happy-desktop-ui="badge"]');
    ...
    const avatar = view.$('[data-testid="ac-pending"] [data-happy-desktop-ui="avatar"]');
    ...
    const header = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-header"]',
    );
    const agentName = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-agent-name"]',
    );
    ...
    expect(agentName.computedStyle("color")).toBe("rgb(73, 69, 79)");
    ...
    const agent = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-agent"]',
    );
    ...
    const title = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-title"]',
    );
    ...
    const reason = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-reason"]',
    );
    ...
    expect(reason.computedStyle("color")).toBe("rgb(73, 69, 79)");
    expect((await reason.visibleMetrics()).pixelCount).toBeGreaterThan(0);

    const action = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-action"]',
    );
    ...
    const actionText = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-action-text"]',
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-details"]',
        ),
    ).toBeNull();

    /* ---- Footer actions -------------------------------------------------- */

    const footer = view.$('[data-testid="ac-pending"] .happy-desktop-approval-card__footer');
    ...
    const toggle = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-toggle"]',
    );
    ...
    const toggleLabel = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-toggle-label"]',
    );
    ...
    const chevron = view.$(
        '[data-testid="ac-pending"] [data-happy-desktop-ui="approval-card-toggle"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const details = view.$(
        '[data-testid="ac-expanded"] [data-happy-desktop-ui="approval-card-details"]',
    );
    ...
    const impact = view.$(
        '[data-testid="ac-expanded"] [data-happy-desktop-ui="approval-card-impact"]',
    );
    expect(impact.textMetrics().font.size).toBe(13);
    expect(impact.computedStyle("color")).toBe("rgb(73, 69, 79)");
    expect((await impact.visibleMetrics()).pixelCount).toBeGreaterThan(0);

    const resources = Array.from(
        view.container.querySelectorAll(
            '[data-testid="ac-expanded"] [data-happy-desktop-ui="approval-card-resources"] [data-happy-desktop-ui="badge"]',
        ),
    );
    ...
    const upChevron = view.$(
        '[data-testid="ac-expanded"] [data-happy-desktop-ui="approval-card-toggle"] [data-happy-desktop-ui="icon"]',
    );
    ...
    expect(
        view
            .$('[data-testid="ac-expanded"] [data-happy-desktop-ui="approval-card-toggle"]')
...
it("holds resolved ApprovalCard banners, state lines, and optical centering", async () => {
    ...
    for (const id of ["ac-approved", "ac-denied"] as const) {
        ...
        const banner = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-banner"]`,
        );
        ...
        const bannerLabel = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-banner-label"]`,
        );
        ...
        const bannerIcon = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-banner"] [data-happy-desktop-ui="icon"]`,
        );
        ...
        expect(
            view.container.querySelector(`[data-testid="${id}"] [data-happy-desktop-ui="button"]`),
        ).toBeNull();
        const state = view.$(`[data-testid="${id}"] [data-happy-desktop-ui="approval-card-state"]`);
        expect(state.computedStyle("color")).toBe("rgb(73, 69, 79)");
        const stateLabel = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-state-label"]`,
        );
        ...
        const stateIcon = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-state"] [data-happy-desktop-ui="icon"]`,
        );
        expect(
        ...
        expect(
            view
                .$(`[data-testid="${id}"] [data-happy-desktop-ui="approval-card-toggle"]`)
                .element.getAttribute("aria-expanded"),
        ).toBe("false");
    }
    ...
    const banner = view.$(
        '[data-testid="ac-approved"] [data-happy-desktop-ui="approval-card-banner"]',
    );
    ...
    expect(
        view
            .$('[data-testid="ac-approved"] [data-happy-desktop-ui="approval-card-chip"]')
    ...
    expect(
        view
            .$('[data-testid="ac-approved"] [data-happy-desktop-ui="badge"]')
            .element.getAttribute("data-variant"),
    ).toBe("neutral");
    expect(
        view
            .$(
                '[data-testid="ac-approved"] [data-happy-desktop-ui="approval-card-state"] [data-happy-desktop-ui="icon"]',
            )
            .computedStyle("color"),
    ).toBe("rgb(52, 199, 89)");
    const deniedBanner = view.$(
        '[data-testid="ac-denied"] [data-happy-desktop-ui="approval-card-banner"]',
    );
    ...
    expect(
        view
            .$('[data-testid="ac-denied"] [data-happy-desktop-ui="approval-card-chip"]')
            .computedStyle("color"),
    ).toBe("rgb(244, 67, 54)");
...
it("holds expanded resolved ApprovalCards and fluid widths", async () => {
    ...
    for (const id of ["ac-approved-x", "ac-denied-x"] as const) {
        ...
        const details = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-details"]`,
        );
        expect(details.bounds().y - cardEl.bounds().y).toBe(177); /* banner 32 + body 145 */
        const resources = Array.from(
            view.container.querySelectorAll(
                `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-resources"] [data-happy-desktop-ui="badge"]`,
            ),
        );
        expect(resources.length).toBe(3);
        ...
        const shield = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="approval-card-chip"] [data-happy-desktop-ui="icon"]`,
        );
    ...
    const narrowAction = view.$(
        '[data-testid="ac-narrow"] [data-happy-desktop-ui="approval-card-action"]',
    );
    ...
    const narrowActionText = view.$(
        '[data-testid="ac-narrow"] [data-happy-desktop-ui="approval-card-action-text"]',
    );
    ...
    expect(
        view.$('[data-testid="ac-narrow"] [data-happy-desktop-ui="badge"]').textMetrics().text,
    ).toBe("ESCALATION");
