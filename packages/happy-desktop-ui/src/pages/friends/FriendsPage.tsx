...
export function FriendsPage(props: FriendsPageProps) {
    ...
    return (
        <div
            ...
            style={props.style}
        >
            <div className="happy2-friends__header" data-happy-desktop-ui="friends-header">
                <Toolbar
            ...
            <div className="happy2-friends__scroll" data-happy-desktop-ui="friends-scroll">
                <div className="happy2-friends__content" data-happy-desktop-ui="friends-content">
                    {props.error ? (
                    ...
                    {requests.length > 0 ? (
                        <section
                            ...
                            data-happy-desktop-ui="friends-requests"
                        >
                    ...
                    {account ? (
                        <section
                            className="happy2-friends__section"
                            data-happy-desktop-ui="friends-people"
                        >
                            <SectionLabel count={friends.length} label="People" />
                            {friends.length === 0 ? (
                                <p
                                    className="happy2-friends__nobody"
                                    data-happy-desktop-ui="friends-nobody"
                                >
                                    Nobody yet. Send someone your code, or paste theirs above.
                                </p>
                            ) : (
                                <div
                                    className="happy2-friends__list"
                                    data-happy-desktop-ui="friends-list"
                                >
                                    {friends.map((friend) => {
                                        ...
                                        return props.onFriendOpen ? (
                                            <button
                                                ...
                                                data-happy-desktop-ui="friends-row"
                                                key={friend.id}
...
function ProfileHero({ account }: { account: RigFriendsAccount }) {
    ...
    return (
        <div className="happy2-friends__hero" data-happy-desktop-ui="friends-hero">
            <Avatar
                aria-label={name}
            ...
            <span className="happy2-friends__hero-identity">
                <span
                    className="happy2-friends__hero-name"
                    data-happy-desktop-ui="friends-hero-name"
                >
                    {name}
                </span>
...
function SectionLabel(props: { count: number; label: string }) {
    return (
        <h2 className="happy2-friends__section-title" data-happy-desktop-ui="friends-section-title">
    ...
    return (
        <>
            ...
            <span className="happy2-friends__body">
                <span className="happy2-friends__name" data-happy-desktop-ui="friends-name">
                    {name}
                </span>
