...
import type { ConversationComputeState } from "happy2-state";
...
export function ConversationComputeEvent(props: ConversationComputeEventProps) {
    ...
    return (
        <div
            ...
            data-happy2-ui="conversation-compute"
        ...
        >
            <div
                ...
                data-happy2-ui="conversation-compute-row"
            >
                <span
                    aria-hidden="true"
                    className="happy2-conversation-compute__icon"
                    data-happy2-ui="conversation-compute-icon"
                >
                    <Ionicon name={state.glyph} size={14} />
                </span>
                <span
                    className="happy2-conversation-compute__label"
                    data-happy2-ui="conversation-compute-label"
                >
                    {state.label}
                </span>
                ...
                <ScrollingText
                    ...
                    data-happy2-ui="conversation-compute-message"
                >
                    {props.message}
                </ScrollingText>
                {progress === undefined ? null : (
                    <span
                        ...
                        data-happy2-ui="conversation-compute-percent"
                    >
                        {progress}
                    </span>
                )}
                {elapsed === undefined ? null : (
                    <span
                        className="happy2-conversation-compute__metric"
                        data-happy2-ui="conversation-compute-elapsed"
                    >
                        {elapsed}
                    </span>
                )}
                <button
                    ...
                    data-happy2-ui="conversation-compute-toggle"
                ...
                <CopyButton
                    data-happy2-ui="conversation-compute-copy"
            ...
            {open ? (
                <div
                    ...
                    data-happy2-ui="conversation-compute-details"
                >
...
function ComputeDetail(props: { readonly label: string; readonly value: string }) {
    return (
        <span
            ...
            data-happy2-ui="conversation-compute-detail"
        >
