            ...
            <div className="happy2-session-share-start__body">
                ...
                {empty ? (
                    <p
                        ...
                        data-happy2-ui="session-share-start-reason"
                    >
                        {props.loading
                    ...
                    <ul
                        ...
                        data-happy2-ui="session-share-start-list"
                    >
                        {props.candidates.map((candidate) => {
                            ...
                            return (
                                <li
                                    ...
                                    data-happy2-ui="session-share-candidate"
                                    data-selected={
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            data-happy2-ui="session-share-candidate-name"
                                        >
                                            {candidate.name}
                                        </span>
                                    </label>
                ...
                <p
                    ...
                    data-happy2-ui="session-share-start-standing"
                >
