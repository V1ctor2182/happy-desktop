 ...
 */
export interface HappyAgentNavigationOrderDocument {
 ...
 * lifetime only.
 */
export interface HappyAgentNavigationOrderPersistence {
    read(): HappyAgentNavigationOrderDocument | undefined;
    write(document: HappyAgentNavigationOrderDocument): void;
}

export interface HappyAgentNavigationOrderSnapshot {
    /** Every row this window has ever been told where to put, in that order. */
    readonly order: readonly string[];
}

export interface HappyAgentNavigationOrderStore {
    get(): HappyAgentNavigationOrderSnapshot;
 ...
 */
export function happyAgentNavigationOrderApply(
    ids: readonly string[],
 ...
 */
function documentParse(value: unknown): HappyAgentNavigationOrderDocument | undefined {
...
const EMPTY_SNAPSHOT: HappyAgentNavigationOrderSnapshot = { order: [] };
 ...
 */
export function happyAgentNavigationOrderStoreCreate(
    persistence?: HappyAgentNavigationOrderPersistence,
): HappyAgentNavigationOrderStore {
    let snapshot: HappyAgentNavigationOrderSnapshot = (() => {
        try {
 ...
 */
export const happyAgentNavigationOrderStoreNoop: HappyAgentNavigationOrderStore = {
    get: () => EMPTY_SNAPSHOT,
    subscribe: () => () => undefined,
