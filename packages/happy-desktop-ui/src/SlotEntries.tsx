...
function SlotDetails(props: { readonly entry: SlotVisualEntry; readonly labelledBy: string }) {
    ...
    return (
        <div
            ...
            data-happy-desktop-ui="slot-entry-details"
            role="group"
        >
...
function SlotItem(props: {
    ...
    return (
        <div
            ...
            data-happy-desktop-ui="slot-entry"
        ...
        >
            <div
                ...
                data-happy-desktop-ui="slot-entry-row"
            >
                ...
                {entry.content.type === "text" ? (
                    <div
                        ...
                        data-happy-desktop-ui="slot-entry-text"
                    ...
                    <button
                        ...
                        data-happy-desktop-ui="slot-entry-action"
                    ...
                    <div
                        className="happy2-slot-row__control"
                        data-happy-desktop-ui="slot-entry-action"
                    >
                        <Button
                            disabled={entry.disabled}
                ...
                <button
                    ...
                    data-happy-desktop-ui="slot-entry-inspect"
                    onClick={(event) => {
                        keepFocus(event);
                        if (open) close();
                        else setOpen(true);
                ...
                floating ? (
                    <>
                        ...
                        <div
                            ...
                            data-happy-desktop-ui="slot-entry-popover"
                            id={detailsId}
                        >
                            {details}
                        </div>
...
export function SlotEntries(props: SlotEntriesProps) {
    ...
    return (
        <div
            ...
            data-happy-desktop-ui="slot-entries"
        ...
        >
            ...
            <div className="happy2-slot-entries__list" data-happy-desktop-ui="slot-entries-list">
                {visible.map((entry) => (
                    <SlotItem
                        entry={entry}
                        key={entry.id}
            ...
            {switching && count > 1 ? (
                <>
                    <div className="happy2-slot-switch" data-happy-desktop-ui="slot-entries-switch">
                        <button
