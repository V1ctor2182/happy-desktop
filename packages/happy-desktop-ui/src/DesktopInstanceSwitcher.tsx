...
/**
 * C-146 DesktopInstanceSwitcher — compact, keyboard-addressable Rig
 * identity shown above every desktop sidebar body. It switches between the
 * saved Rigs (this machine, or a remote Rig), reports the
        ...
        >
            ...
            >
                {props.targets.map((target, index) => {
                    ...
                    return (
                        <button
                            aria-label={`${target.label}, ${target.kind === "local" ? "local to this machine" : "remote Rig"}`}
                            aria-pressed={active}
                            className="happy2-instance-switcher__target"
                            data-active={active ? "" : undefined}
                            data-happy-desktop-ui="instance-switcher-target"
                        ...
                        >
                            <span
                                ...
                                data-happy-desktop-ui="instance-switcher-target-icon"
                            >
                                <Icon
            ...
            <div
                className="happy2-instance-switcher__meta"
                data-happy-desktop-ui="instance-switcher-meta"
            >
                <span
                    className="happy2-instance-switcher__status"
                    data-happy-desktop-ui="instance-switcher-status"
                    data-tone={
