...
export function OnboardingScreen(props: OnboardingScreenProps) {
    ...
    return (
        <div
            ...
            data-happy-desktop-ui="onboarding-screen"
            data-state={state()}
        ...
        >
            {local.brand
                ? ((brand) => (
                      <div
                          ...
                          data-happy-desktop-ui="onboarding-mast"
                      >
                          <div
                              className="happy2-onboarding-screen__brand"
                              data-happy-desktop-ui="onboarding-brand"
                          >
                              <span
                                  className="happy2-onboarding-screen__mark"
                                  data-happy-desktop-ui="onboarding-mark"
                              >
                                  {brand.mark ?? (
                                      <img
                                          alt=""
                                          ...
                                          data-happy-desktop-ui="onboarding-mark-image"
                                          src={happyLogoUrl}
                                      />
                                  )}
                              </span>
                              <span
                                  ...
                                  data-happy-desktop-ui="onboarding-brand-name"
                              >
                                  {brand.name}
                              </span>
                          </div>
            ...
            >
                <div
                    ...
                    data-happy-desktop-ui="onboarding-body-content"
                >
                    {steps().length > 0 ? (
                        <div
                            className="happy2-onboarding-screen__steps"
                            data-happy-desktop-ui="onboarding-steps"
                        >
                            {steps().map((step) => (
                                <div
                                    key={step.label}
                                    className="happy2-onboarding-screen__step"
                                    data-happy-desktop-ui="onboarding-step"
                                    data-state={step.state}
                                >
                                    <span
                                        className="happy2-onboarding-screen__step-bar"
                                        data-happy-desktop-ui="onboarding-step-bar"
                                        data-state={step.state}
                                    />
                                    <span
                                        className="happy2-onboarding-screen__step-label"
                                        data-happy-desktop-ui="onboarding-step-label"
                                        data-state={step.state}
                                    >
                                        {step.label}
                                    </span>
                    ...
                    <div
                        ...
                        data-happy-desktop-ui="onboarding-content"
                    >
                        {local.kicker ? (
                            <p
                                className="happy2-onboarding-screen__kicker"
                                data-happy-desktop-ui="onboarding-kicker"
                            >
                                {local.kicker}
                            </p>
                        ) : null}
                        <h1
                            ...
                            data-happy-desktop-ui="onboarding-title"
                        >
                            {local.title}
                        </h1>
                        {local.copy ? (
                            <p
                                ...
                                data-happy-desktop-ui="onboarding-copy"
                            >
                                {local.copy}
                            </p>
                        ) : null}
                    ...
                    <div
                        ...
                        data-happy-desktop-ui="onboarding-slot"
                    >
                        {state() === "loading" ? (
                            <div
                                className="happy2-onboarding-screen__loader"
                                data-happy-desktop-ui="onboarding-loader"
                                role="status"
                            >
                                <span
                                    className="happy2-onboarding-screen__spinner"
                                    data-happy-desktop-ui="onboarding-spinner"
                                />
                                <span
                                    className="happy2-onboarding-screen__loading-label"
                                    data-happy-desktop-ui="onboarding-loading-label"
                                >
            ...
            {local.footer ? (
                <div
                    ...
                    data-happy-desktop-ui="onboarding-footer"
                >
                    <div
                        className="happy2-onboarding-screen__footer-content"
                        data-happy-desktop-ui="onboarding-footer-content"
                    >
                        {local.footer}
                    </div>
                </div>
