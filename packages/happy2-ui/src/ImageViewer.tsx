    ...
    return (
        ...
        >
            <div
                ...
                data-happy2-ui="image-viewer-frame"
            ...
            <div className="happy2-image-viewer__tools" data-happy2-ui="image-viewer-tools">
                {local.actions}
                <Button
                    aria-label="Zoom out"
                ...
                <span className="happy2-image-viewer__zoom" data-happy2-ui="image-viewer-zoom">
            ...
            <span
                ...
                data-happy2-ui="image-viewer-announcement"
                role="status"
            >
                {spoken}
            </span>
...
function ImageViewerStage(props: {
    ...
    if (props.content.type === "unavailable")
        return (
            <div className="happy2-image-viewer__notice" data-happy2-ui="image-viewer-unavailable">
    ...
    return (
        <>
            ...
            <img
                ...
                data-happy2-ui="image-viewer-image"
                draggable={false}
...
function ImageViewerOpening(props: { name: string }) {
    return (
        <div className="happy2-image-viewer__notice" data-happy2-ui="image-viewer-loading">
            <Spinner size={16} />
...
function ImageViewerFailure(props: { detail: string; name: string }) {
    return (
        <div
            ...
            data-happy2-ui="image-viewer-error"
            data-tone="danger"
        >
