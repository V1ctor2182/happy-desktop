...
const part = (view: Renderer, testId: string, name: string) =>
    view.$(`[data-testid="${testId}"] [data-happy-desktop-ui="${name}"]`);
...
it("holds SetupOptionCard layout, typography, selection, and status geometry", async () => {
    ...
    const chipGlyphSelector =
        '[data-testid="chip"] [data-happy-desktop-ui="setup-option-icon"] [data-happy-desktop-ui="icon"]';
    ...
    const chipOffset = iconBoxOffset(
        view,
        '[data-testid="chip"] [data-happy-desktop-ui="setup-option-icon"]',
        chipGlyphSelector,
    );
    ...
    expect(
        status.element.querySelector('[data-happy-desktop-ui="badge"]'),
    ...
    expect(
        view.container.querySelector(
            '[data-testid="selected"] [data-happy-desktop-ui="setup-option-spinner"]',
        ),
    ...
    const checkGlyphSelector =
        '[data-testid="selected"] [data-happy-desktop-ui="setup-option-check"] [data-happy-desktop-ui="icon"]';
    const checkOffset = iconBoxOffset(
        view,
        '[data-testid="selected"] [data-happy-desktop-ui="setup-option-trailing"]',
        checkGlyphSelector,
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="pending"] [data-happy-desktop-ui="setup-option-check"]',
        ),
