...
export function SplitColumn(props: SplitColumnProps) {
    ...
    return (
        ...
        >
            <div className="happy2-split-column__top" data-happy2-ui="split-column-top">
                {props.top}
            </div>
            <div
                ...
                data-happy2-ui="split-column-handle"
                onKeyDown={(event) => {
                    const delta =
                        event.key === "ArrowUp"
                            ? KEYBOARD_STEP
                ...
                tabIndex={0}
            >
                <span className="happy2-split-column__line" data-happy2-ui="split-column-line" />
            </div>
            <div
                className="happy2-split-column__bottom"
                data-happy2-ui="split-column-bottom"
                ref={bottom}
