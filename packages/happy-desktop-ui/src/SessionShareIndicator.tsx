...
export function SessionShareIndicator(props: SessionShareIndicatorProps) {
    ...
    return (
        <div
            ...
            data-happy-desktop-ui="session-share-indicator"
        ...
        >
            <span
                ...
                data-happy-desktop-ui="session-share-indicator-mark"
            >
                <Icon name="eye" size={16} />
            </span>
            <div
                className="happy2-session-share-indicator__text"
                data-happy-desktop-ui="session-share-indicator-text"
            >
                <span
                    className="happy2-session-share-indicator__line"
                    data-happy-desktop-ui="session-share-indicator-line"
                >
                    <span
                        className="happy2-session-share-indicator__label"
                        data-happy-desktop-ui="session-share-indicator-label"
                    >
                        {SESSION_SHARE_CONDITION_LABELS[local.condition]}
                    </span>
                    <span
                        className="happy2-session-share-indicator__sentence"
                        data-happy-desktop-ui="session-share-indicator-sentence"
                    >
            ...
            {local.onManage || (local.onStop && !ended) ? (
                <div
                    ...
                    data-happy-desktop-ui="session-share-indicator-actions"
                >
                    {local.onManage ? (
