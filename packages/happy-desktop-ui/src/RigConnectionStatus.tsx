        ...
        <>
            ...
            >
                <div
                    ...
                    data-happy-desktop-ui="rig-connection-status-body"
                >
                    <span
                        className="happy2-rig-connection-status__loader"
                        data-happy-desktop-ui="rig-connection-status-loader"
                    >
                        {model.loading ? (
                    ...
                    <strong
                        ...
                        data-happy-desktop-ui="rig-connection-status-label"
                    >
                        {model.status}
                    </strong>
                    <span
                        className="happy2-rig-connection-status__progress"
                        data-happy-desktop-ui="rig-connection-status-progress"
                    >
                        {model.progress}
                    </span>
                    {canRetry ? (
