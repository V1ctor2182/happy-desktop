...
import type { RigFriendsInviteDraft } from "happy2-state";
...
export function FriendInvite(props: FriendInviteProps) {
    ...
    return (
        <div
            ...
            data-happy2-ui="friend-invite"
            data-testid={props["data-testid"]}
            style={props.style}
        >
            <div className="happy2-friend-invite__half" data-happy2-ui="friend-invite-mine">
                ...
                <div className="happy2-friend-invite__well">
                    <span
                        ...
                        data-happy2-ui="friend-invite-code"
                        title={props.code}
                    >
                        {props.code}
                    </span>
                    <CopyButton
                        data-happy2-ui="friend-invite-copy"
            ...
            <div className="happy2-friend-invite__half" data-happy2-ui="friend-invite-send">
                ...
                {draft.error ? (
                    <span
                        ...
                        data-happy2-ui="friend-invite-error"
                        role="alert"
                    >
                        {draft.error.message}
                    </span>
                    ...
                    <span
                        ...
                        data-happy2-ui="friend-invite-sent"
                        role="status"
                    >
