...
it("keeps the send action inside every measured toolbar stage", async () => {
    ...
    for (const stage of stages) {
        ...
        expect(
            view.container.querySelector(`${rootSelector} [data-happy-desktop-ui="composer-hint"]`),
        ).toBeNull();
        expect(
            view.container.querySelector(
                `${rootSelector} [data-happy-desktop-ui="composer-hint-compact"]`,
            ),
        ).toBeNull();
        ...
        if (stage.audience) {
            const toggle = view.$(`${rootSelector} [data-happy-desktop-ui="audience-toggle"]`);
