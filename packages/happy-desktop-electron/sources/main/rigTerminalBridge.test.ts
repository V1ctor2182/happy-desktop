...
import {
    ...
    rigTerminalBridgeCreate,
    type RigTerminalBridge,
...
interface Fixture {
    ...
    readonly bridge: RigTerminalBridge;
...
async function fixtureCreate(
    ...
    const bridge = rigTerminalBridgeCreate({
...
function connect(
    ...
    const protocols = [RIG_TERMINAL_PROTOCOL];
    if (options.capability)
        protocols.push(`${RIG_TERMINAL_CAPABILITY_PROTOCOL_PREFIX}${options.capability}`);
