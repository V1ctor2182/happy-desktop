...
function GoalSection(props: { goal: RigGoal }) {
    const { goal } = props;
    return (
        <section className="happy2-rig-activity__section" data-happy2-ui="rig-activity-goal">
            ...
            <div className="happy2-rig-activity__goal">
                <span
                    ...
                    data-happy2-ui="rig-activity-goal-status"
                >
...
function TaskRow(props: { task: RigTask }) {
    ...
    return (
        <li className="happy2-rig-activity__task" data-happy2-ui="rig-activity-task">
            <span
                className="happy2-rig-activity__status"
                data-status={task.status}
                data-happy2-ui="rig-activity-task-status"
            >
...
function SubagentRow(props: { subagent: RigSubagentSummary; now: number }) {
    ...
    return (
        <li className="happy2-rig-activity__subagent" data-happy2-ui="rig-activity-subagent">
            <div className="happy2-rig-activity__subagent-head">
                <span
                    className="happy2-rig-activity__status"
                    data-status={subagent.status}
                    data-happy2-ui="rig-activity-subagent-status"
                >
...
function BackgroundProcessRow(props: {
    ...
    const { process } = props;
    return (
        <li className="happy2-rig-activity__process" data-happy2-ui="rig-activity-process">
            <span
                className="happy2-rig-activity__status"
                data-status="running"
                data-happy2-ui="rig-activity-process-status"
            >
                Running
            </span>
            ...
            {props.onStop ? (
                <button
                    ...
                    data-happy2-ui="rig-activity-process-stop"
...
export function RigActivityPanel(props: RigActivityPanelProps) {
    ...
    return (
        <section
            ...
            data-happy2-ui="rig-activity-panel"
            data-testid={props["data-testid"]}
            style={props.style}
        >
            {empty ? (
                <p className="happy2-rig-activity__empty" data-happy2-ui="rig-activity-empty">
                ...
                <>
                    ...
                    {tasks.length > 0 ? (
                        <section
                            ...
                            data-happy2-ui="rig-activity-tasks"
                        >
                    ...
                    {subagents.length > 0 ? (
                        <section
                            className="happy2-rig-activity__section"
                            data-happy2-ui="rig-activity-subagents"
                        >
                            <h3 className="happy2-rig-activity__heading">
                                Subagents
                    ...
                    {backgroundProcesses.length > 0 ? (
                        <section
                            className="happy2-rig-activity__section"
                            data-happy2-ui="rig-activity-processes"
                        >
                            <h3 className="happy2-rig-activity__heading">
