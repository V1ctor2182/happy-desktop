...
it("holds Modal dialog geometry, header/body/footer layout, and optical glyph centering", async () => {
    ...
    const dialog = view.$('[data-testid="md"] [data-happy2-ui="modal-dialog"]');
    ...
    const header = view.$('[data-testid="md"] [data-happy2-ui="modal-header"]');
    ...
    const footer = view.$('[data-testid="md"] [data-happy2-ui="modal-footer"]');
    ...
    const small = view.$('[data-happy2-ui="modal-dialog"][data-size="small"]');
    expect(small.width()).toBe(360);
    const large = view.$('[data-happy2-ui="modal-dialog"][data-size="large"]');
...
it("holds Modal tone treatments and the minimal (no icon / footer / close) form", async () => {
    ...
    const dangerDialog = view.$('[data-testid="danger"] [data-happy2-ui="modal-dialog"]');
    ...
    const minimal = view.$('[data-testid="minimal"] [data-happy2-ui="modal-dialog"]');
    expect(minimal.width()).toBe(360);
    const minimalHeader = view.$('[data-testid="minimal"] [data-happy2-ui="modal-header"]');
    expect(minimalHeader.bounds().height).toBe(60);
    expect(
        view.container.querySelector('[data-testid="minimal"] [data-happy2-ui="modal-icon"]'),
    ).toBeNull();
    expect(view.container.querySelector('[data-testid="minimal"] .happy2-modal__close')).toBeNull();
    expect(
        view.container.querySelector('[data-testid="minimal"] [data-happy2-ui="modal-footer"]'),
    ).toBeNull();
    /* Title occupies the full inset with no chip/close: starts on the 20px pad. */
    const minimalTitle = view.$('[data-testid="minimal"] [data-happy2-ui="modal-title"]');
