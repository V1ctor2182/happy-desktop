...
it("holds DataTable geometry, alignment, selection, and header typography", async () => {
    ...
    const table = view.$('[data-happy-desktop-ui="data-table-table"]');
    ...
    const headRow = view.$('[data-happy-desktop-ui="data-table-head-row"]');
    expect(headRow.bounds().height, "header row height").toBe(40);
    const nameTh = view.$('[data-happy-desktop-ui="data-table-head"] [data-column-id="name"]');
    ...
    const nameLabel = view.$('[data-column-id="name"] [data-happy-desktop-ui="data-table-header"]');
    const seatsLabel = view.$(
        '[data-column-id="seats"] [data-happy-desktop-ui="data-table-header"]',
    );
    ...
    const nameTd = view.$('[data-happy-desktop-ui="data-table-body"] [data-column-id="name"]');
    expect(nameTd.height(), "body cell height").toBe(48);
    const emailTd = view.$('[data-happy-desktop-ui="data-table-body"] [data-column-id="email"]');
    expect(
    ...
    const lastRowTd = view.$(
        '[data-happy-desktop-ui="data-table-body"] [data-row-id="alan"] [data-column-id="email"]',
    );
    ...
    const graceTd = view.$(
        '[data-happy-desktop-ui="data-table-body"] [data-row-id="grace"] [data-column-id="email"]',
    );
    ...
    const emailCell = view.$(
        '[data-happy-desktop-ui="data-table-body"] [data-column-id="email"] [data-happy-desktop-ui="data-table-cell"]',
    );
    expect(Math.abs(emailCell.offsets().left - 16), "start-aligned left pad").toBeLessThanOrEqual(
        0.5,
    );
    const seatsCell = view.$(
        '[data-happy-desktop-ui="data-table-body"] [data-column-id="seats"] [data-happy-desktop-ui="data-table-cell"]',
    );
    ...
    const actions = view.$(
        '[data-happy-desktop-ui="data-table-body"] [data-happy-desktop-ui="data-table-actions"]',
    );
    ...
    const checkBox = view.$(
        '[data-happy-desktop-ui="data-table-select-row"] [data-happy-desktop-ui="data-table-check-box"]',
    );
    ...
    const glyph = view.$(
        '[data-happy-desktop-ui="data-table-select-row"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const headerBox = view.$(
        '[data-happy-desktop-ui="data-table-select-all"] [data-happy-desktop-ui="data-table-check-box"]',
    );
...
it("holds DataTable dense rows, truncation, and the empty slot", async () => {
    ...
    const denseHead = view.$('[data-happy-desktop-ui="data-table-head-row"]');
    expect(denseHead.bounds().height, "dense header height").toBe(36);
    const denseTd = view.$('[data-happy-desktop-ui="data-table-body"] [data-column-id="name"]');
    ...
    const pathCell = view.$('[data-column-id="path"] [data-happy-desktop-ui="data-table-cell"]');
    expect(
    ...
    const empty = view.$('[data-happy-desktop-ui="data-table-empty"]');
