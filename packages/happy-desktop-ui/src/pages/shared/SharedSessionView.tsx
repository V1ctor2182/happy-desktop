...
import type { ComposerSnapshot, ConversationAuthor, ConversationEntry } from "happy-desktop-state";
    ...
    return (
        <section
            ...
            className={["happy2-shared-session happy2-conversation", props.className]
                .filter(Boolean)
                .join(" ")}
            data-happy-desktop-ui="shared-session-view"
        ...
        >
            ...
            <div
                ...
                data-happy-desktop-ui="shared-session-notice"
                data-live={props.live ? "" : undefined}
                role="status"
            >
                ...
                <span
                    ...
                    data-happy-desktop-ui="shared-session-notice-text"
                >
                    {props.live
            ...
            {props.loading && entries.length === 0 ? (
                <div
                    ...
                    data-happy-desktop-ui="shared-session-loading"
                >
                    <Spinner
                ...
                <div
                    className="happy2-shared-session__empty"
                    data-happy-desktop-ui="shared-session-empty"
                >
                    <EmptyState
                ...
                >
                    ...
                    {showMore ? (
                        <div
                            ...
                            data-happy-desktop-ui="shared-session-more"
            ...
            {composer ? (
                <div
                    className="happy2-shared-session__dock"
                    data-happy-desktop-ui="shared-session-dock"
                >
                    {refused ? (
                        <p
                            className="happy2-shared-session__refusal"
                            data-happy-desktop-ui="shared-session-refusal"
                            role="status"
                        >
