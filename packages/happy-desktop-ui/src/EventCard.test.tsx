...
it("holds EventCard geometry, transition lane, and optical centering", async () => {
    ...
    for (const [id, glyph] of [
        ...
        const chipBox = view.$(`[data-testid="${id}"] [data-happy-desktop-ui="event-card-chip"]`);
        ...
        const chipIcon = view.$(
            `[data-testid="${id}"] [data-happy-desktop-ui="event-card-chip"] [data-happy-desktop-ui="icon"]`,
        );
    ...
    const chip = view.$('[data-testid="ev-transition"] [data-happy-desktop-ui="event-card-chip"]');
    ...
    const meta = view.$('[data-testid="ev-transition"] [data-happy-desktop-ui="event-card-meta"]');
    ...
    const from = view.$('[data-testid="ev-transition"] [data-happy-desktop-ui="event-card-from"]');
    const arrow = view.$(
        '[data-testid="ev-transition"] [data-happy-desktop-ui="event-card-transition"] [data-happy-desktop-ui="icon"]',
    );
    const to = view.$('[data-testid="ev-transition"] [data-happy-desktop-ui="event-card-to"]');
    ...
    for (const [id, stamp] of [
        ...
        const timeEl = view.$(`[data-testid="${id}"] [data-happy-desktop-ui="event-card-time"]`);
    ...
    const badge = view.$('[data-testid="ev-badge"] [data-happy-desktop-ui="badge"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="ev-badge"] [data-happy-desktop-ui="event-card-transition"]',
        ),
    ).toBeNull();
    ...
    expect(
        view.container.querySelector(
            '[data-testid="ev-min"] [data-happy-desktop-ui="event-card-chip"]',
        ),
    ).toBeNull();
    expect(
        view.container.querySelector(
            '[data-testid="ev-min"] [data-happy-desktop-ui="event-card-side"]',
        ),
    ).toBeNull();
    const minTitle = view.$('[data-testid="ev-min"] [data-happy-desktop-ui="event-card-title"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="ev-plain"] [data-happy-desktop-ui="event-card-chip"]',
        ),
    ).toBeNull();
    expect(
        view.container.querySelector(
            '[data-testid="ev-plain"] [data-happy-desktop-ui="event-card-transition"]',
        ),
    ).toBeNull();
    const plainTime = view.$('[data-testid="ev-plain"] [data-happy-desktop-ui="event-card-time"]');
    expect(plain.bounds().x + 680 - (plainTime.bounds().x + plainTime.bounds().width)).toBe(13);
    const plainTitle = view.$(
        '[data-testid="ev-plain"] [data-happy-desktop-ui="event-card-title"]',
    );
    ...
    const narrowTitle = view.$(
        '[data-testid="ev-narrow"] [data-happy-desktop-ui="event-card-title"]',
    );
    expect(narrowTitle.computedStyles(["overflow-x", "text-overflow"])).toEqual({
        "overflow-x": "hidden",
        "text-overflow": "ellipsis",
    });
    const narrowLane = view.$(
        '[data-testid="ev-narrow"] [data-happy-desktop-ui="event-card-transition"]',
    );
    ...
    const narrowFrom = view.$(
        '[data-testid="ev-narrow"] [data-happy-desktop-ui="event-card-from"]',
    );
    ...
    const narrowTo = view.$('[data-testid="ev-narrow"] [data-happy-desktop-ui="event-card-to"]');
