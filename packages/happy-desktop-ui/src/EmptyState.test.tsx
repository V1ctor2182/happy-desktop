...
it("holds panel EmptyState geometry, medallion centering, and typography", async () => {
    ...
    const media = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="empty-state-media"]',
    );
    ...
    const icon = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="empty-state-media"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const title = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="empty-state-title"]',
    );
    ...
    const description = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="empty-state-description"]',
    );
    ...
    const actions = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="empty-state-actions"]',
    );
    expect(
    ...
    const button = view.$('[data-testid="es-panel-full"] [data-happy-desktop-ui="button"]');
    ...
    const buttonLabel = view.$(
        '[data-testid="es-panel-full"] [data-happy-desktop-ui="button"] [data-happy-desktop-ui="button-label"]',
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="es-panel-min"] [data-happy-desktop-ui="empty-state-description"]',
        ),
        "minimal has no description",
    ).toBeNull();
    expect(
        view.container.querySelector(
            '[data-testid="es-panel-min"] [data-happy-desktop-ui="button"]',
        ),
        "minimal has no action",
    ).toBeNull();
    const minMedia = view.$(
        '[data-testid="es-panel-min"] [data-happy-desktop-ui="empty-state-media"]',
    );
    const minTitle = view.$(
        '[data-testid="es-panel-min"] [data-happy-desktop-ui="empty-state-title"]',
    );
    ...
    const minIcon = view.$(
        '[data-testid="es-panel-min"] [data-happy-desktop-ui="empty-state-media"] [data-happy-desktop-ui="icon"]',
    );
...
it("holds inline EmptyState sizing, rhythm, and action variants", async () => {
    ...
    const media = view.$(
        '[data-testid="es-inline-full"] [data-happy-desktop-ui="empty-state-media"]',
    );
    ...
    const icon = view.$(
        '[data-testid="es-inline-full"] [data-happy-desktop-ui="empty-state-media"] [data-happy-desktop-ui="icon"]',
    );
    ...
    const title = view.$(
        '[data-testid="es-inline-full"] [data-happy-desktop-ui="empty-state-title"]',
    );
    ...
    const description = view.$(
        '[data-testid="es-inline-full"] [data-happy-desktop-ui="empty-state-description"]',
    );
    expect(
        description.bounds().y - title.bounds().y - title.bounds().height,
    ...
    const actions = view.$(
        '[data-testid="es-inline-full"] [data-happy-desktop-ui="empty-state-actions"]',
    );
    expect(
        actions.bounds().y - description.bounds().y - description.bounds().height,
        "inline action rhythm",
    ).toBe(16);
    const button = view.$('[data-testid="es-inline-full"] [data-happy-desktop-ui="button"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="es-inline-plain"] [data-happy-desktop-ui="button"]',
        ),
        "no-action variant omits the button",
    ).toBeNull();
    const plainMedia = view.$(
        '[data-testid="es-inline-plain"] [data-happy-desktop-ui="empty-state-media"]',
    );
    const plainTitle = view.$(
        '[data-testid="es-inline-plain"] [data-happy-desktop-ui="empty-state-title"]',
    );
    const plainDesc = view.$(
        '[data-testid="es-inline-plain"] [data-happy-desktop-ui="empty-state-description"]',
    );
    ...
    const plainIcon = view.$(
        '[data-testid="es-inline-plain"] [data-happy-desktop-ui="empty-state-media"] [data-happy-desktop-ui="icon"]',
    );
