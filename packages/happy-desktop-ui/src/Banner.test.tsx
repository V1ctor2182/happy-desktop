...
it("holds Banner tone tokens, geometry, typography, and leading-icon slots", async () => {
    ...
    for (const tone of tones) {
        ...
        const slot = view.$(`[data-testid="tone-${tone}"] [data-happy-desktop-ui="banner-icon"]`);
        ...
        const glyph = view.$(
            `[data-testid="tone-${tone}"] [data-happy-desktop-ui="banner-icon"] [data-happy-desktop-ui="icon"]`,
        );
        ...
        const title = view.$(`[data-testid="tone-${tone}"] [data-happy-desktop-ui="banner-title"]`);
        const message = view.$(
            `[data-testid="tone-${tone}"] [data-happy-desktop-ui="banner-message"]`,
        );
    ...
    const dismiss = view.$('[data-testid="tone-info"] [data-happy-desktop-ui="banner-dismiss"]');
    ...
    const dismissGlyph = view.$(
        '[data-testid="tone-info"] [data-happy-desktop-ui="banner-dismiss"] [data-happy-desktop-ui="icon"]',
    );
...
it("holds Banner layout modes: message-only, no-icon, action, dismiss, and wrapping", async () => {
    ...
    const singleMsg = view.$('[data-testid="single"] [data-happy-desktop-ui="banner-message"]');
    ...
    const singleSlot = view.$('[data-testid="single"] [data-happy-desktop-ui="banner-icon"]');
    expect(singleSlot.bounds()).toMatchObject({ width: 18, height: 18 });
    const singleGlyph = view.$(
        '[data-testid="single"] [data-happy-desktop-ui="banner-icon"] [data-happy-desktop-ui="icon"]',
    );
    ...
    expect(
        view.container.querySelector(
            '[data-testid="no-icon"] [data-happy-desktop-ui="banner-icon"]',
        ),
    ).toBeNull();
    const noIconMsg = view.$('[data-testid="no-icon"] [data-happy-desktop-ui="banner-message"]');
    ...
    const fullDismiss = view.$('[data-testid="full"] [data-happy-desktop-ui="banner-dismiss"]');
    ...
    expect(
        view.container.querySelector(
            '[data-testid="action-only"] [data-happy-desktop-ui="banner-dismiss"]',
        ),
    ).toBeNull();
    ...
    const wrapMsg = view.$('[data-testid="wrap"] [data-happy-desktop-ui="banner-message"]');
    ...
    const wrapSlot = view.$('[data-testid="wrap"] [data-happy-desktop-ui="banner-icon"]');
    expect(wrapSlot.bounds()).toMatchObject({ width: 18, height: 18 });
    const wrapGlyph = view.$(
        '[data-testid="wrap"] [data-happy-desktop-ui="banner-icon"] [data-happy-desktop-ui="icon"]',
    );
