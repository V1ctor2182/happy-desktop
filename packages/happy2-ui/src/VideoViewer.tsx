    ...
    return (
        ...
        >
            <div
                ...
                data-happy2-ui="video-viewer-frame"
                onKeyDown={keyDown}
                ref={frameElement}
                role="group"
            ...
            {controls ? (
                <div
                    ...
                    data-happy2-ui="video-viewer-bar"
                ...
                >
                    ...
                    <div
                        ...
                        data-happy2-ui="video-viewer-transport"
                    >
            ...
            <span
                ...
                data-happy2-ui="video-viewer-announcement"
                role="status"
            >
                {spoken}
            </span>
    ...
    return (
        <>
            ...
            <video
                ...
                data-happy2-ui="video-viewer-video"
            ...
            <button
                ...
                data-happy2-ui="video-viewer-surface"
                onClick={onActivate}
            ...
            {state.status === "blocked" ? (
                <div className="happy2-video-viewer__notice" data-happy2-ui="video-viewer-blocked">
            ...
            {state.pictureInPicture ? (
                <div className="happy2-video-viewer__notice" data-happy2-ui="video-viewer-detached">
            ...
            {state.waiting && state.status === "ready" ? (
                <div
                    ...
                    data-happy2-ui="video-viewer-buffering"
                    role="status"
                >
                    <Spinner size={20} />
                </div>
...
function VideoViewerTimeline(props: {
    ...
    return (
        <div
            ...
            data-happy2-ui="video-viewer-timeline"
            ...
            tabIndex={inert ? -1 : 0}
        >
            <span className="happy2-video-viewer__track" data-happy2-ui="video-viewer-track">
                <span
                    className="happy2-video-viewer__buffered"
                    data-happy2-ui="video-viewer-buffered"
                    style={{
                ...
                <span
                    ...
                    data-happy2-ui="video-viewer-played"
                    style={{ width: `${String(played * 100)}%` }}
                />
            </span>
            <span
                className="happy2-video-viewer__handle"
                data-happy2-ui="video-viewer-handle"
...
function VideoViewerClock(props: {
    ...
    return (
        <span className="happy2-video-viewer__clock" data-happy2-ui="video-viewer-clock">
            <span className="happy2-video-viewer__elapsed" data-happy2-ui="video-viewer-elapsed">
            ...
            {known ? (
                <button
                    ...
                    data-happy2-ui="video-viewer-total"
                ...
                <span className="happy2-video-viewer__total" data-happy2-ui="video-viewer-total">
                    live
                </span>
            )}
        </span>
        ...
        level === 0
            ...
            : level < 0.34
              ...
              : level < 0.67
                ...
                : "volume-high";
    return (
        <span className="happy2-video-viewer__volume" data-happy2-ui="video-viewer-volume">
            <Button
            ...
            <input
                ...
                data-happy2-ui="video-viewer-level"
                disabled={props.disabled}
                max={1}
                min={0}
...
function VideoViewerRate(props: {
    ...
    return (
        <span
            ...
            data-happy2-ui="video-viewer-rate"
            onBlur={(event) => {
        ...
        >
            ...
            {props.open ? (
                <span className="happy2-video-viewer__rates" data-happy2-ui="video-viewer-rates">
                    <Menu
...
function VideoViewerOpening(props: { name: string }) {
    return (
        <div className="happy2-video-viewer__notice" data-happy2-ui="video-viewer-loading">
            <Spinner size={16} />
