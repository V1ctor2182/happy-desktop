    ...
    return (
        ...
        >
            <div
                ...
                role="dialog"
            >
                <header className="happy2-modal__header" data-happy-desktop-ui="modal-header">
                    {local.icon
                        ? ((name) => (
                              <span
                                  className="happy2-modal__icon"
                        ...
                        : null}
                    <h2 className="happy2-modal__title" data-happy-desktop-ui="modal-title">
                        {local.title}
                    </h2>
                    {local.onClose ? (
                        <Button
