...
\`\`\`
`;
const source = `import { FilePreview } from "happy2-ui";
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    {frame(
                        <FilePreview
                            ...
                            dimensions="640 × 400"
                            onClose={() => {}}
                            path="packages/happy2-ui/src/assets/backgrounds/relay-field.svg"
                            size="18 KB"
                        />,
                    )}
            ...
            <Specimen detail="Monospace, unwrapped" label="Source" number="03" stage="surface">
                {frame(
                    <FilePreview
                        ...
                        path="packages/happy2-app/sources/views/FilesView.tsx"
                        size="312 B"
                    />,
                    300,
                )}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    ...
                    {frame(
                        <FilePreview
                            ...
                            path="packages/happy2-ui/src/removed.png"
                        />,
                        220,
                    )}
                </div>
