...
import type { RigMenusSnapshot } from "happy-desktop-state";
import {
...
const DESTINATIONS: readonly RigCreateSessionDestination[] = [
    ...
    { displayPath: "~/Developer/rig", id: "prj_rig", label: "rig" },
...
export function RigCreateSessionDialogPage() {
    return (
        <ComponentPage
            contract="Props only"
            number="C-238"
