            ...
            <Modal
                ...
                footer={
                    <div
                        ...
                        data-happy2-ui="rig-create-session-footer"
                    >
                        ...
                        <div
                            ...
                            data-happy2-ui="rig-create-session-actions"
                        >
                            <span
                                className="happy2-rig-create-session__chord"
                                data-happy2-ui="rig-create-session-chord"
                            >
                                <KeyCap keys="⌘ENTER" />
                            </span>
                ...
                title="New session"
            >
                <div className="happy2-rig-create-session" data-happy2-ui="rig-create-session">
                    <div
                        className="happy2-rig-create-session__prompt"
                        data-happy2-ui="rig-create-session-prompt"
                    >
                        <textarea
                            aria-label="Task"
                            className="happy2-rig-create-session__input"
                            data-happy2-ui="rig-create-session-input"
                    ...
                    <div
                        ...
                        data-happy2-ui="rig-create-session-where"
                    >
                        <Select
                        ...
                        <span
                            ...
                            data-happy2-ui="rig-create-session-path"
                    ...
                    <div
                        ...
                        data-happy2-ui="rig-create-session-how"
                    >
                        <Select
